...
const OrderItemSchema = new Schema({
  ...
  serviceType: {
    type: String,
    required: true,
    enum: ['Deepclean', 'Deepclean_Sandal', 'Deepclean_Tas', 'deepclean_bag_small', 'deepclean_bag_large', 'one_day_service', 'unyellowing', 'sewing'] as ServiceType[]
  },
  quantity: {
    type: Number,
    required: true,
...
const OrderSchema = new Schema<OrderDocument>(
  {
    ...
    itemType: {
      type: String,
      enum: {
        values: ['Deepclean', 'Deepclean_Sandal', 'Deepclean_Tas', 'deepclean_bag_small', 'deepclean_bag_large', 'one_day_service', 'unyellowing', 'sewing'] as ServiceType[],
