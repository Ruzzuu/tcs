...
var OrderItemSchema = new mongoose_1.Schema({
    ...
    serviceType: {
        type: String,
        required: true,
        enum: ['Deepclean', 'sandal', 'deepclean_tas', 'tas_gunung', 'topi', 'helm', 'one_day_service', 'unyellowing', 'whitening', 'sewing', 'repaint_canvas', 'repaint_leather', 'repaint_suede', 'other']
    },
    quantity: {
        type: Number,
        required: true,
...
var OrderSchema = new mongoose_1.Schema({
    ...
    itemType: {
        type: String,
        enum: {
            values: ['Deepclean', 'sandal', 'deepclean_tas', 'tas_gunung', 'topi', 'helm', 'one_day_service', 'unyellowing', 'whitening', 'sewing', 'repaint_canvas', 'repaint_leather', 'repaint_suede', 'other'],
